		...
		if( !(message instanceof ObjectMessage) ) {
			...
			try {
				...
				if( objectMessage.getObject() instanceof EmailNotification ) {
					...
					System.out.println("Attempting to send email...Email Template :: "+emailNotification.getTemplate().toString());
					...
					if( objectMessage.getObject() != null ) {
						System.out.println("Unknown Object within ObjectMessage...ObjectMessage.getObject type is "+objectMessage.getObject().getClass());
					}
				}
			} catch( JMSException je ) {

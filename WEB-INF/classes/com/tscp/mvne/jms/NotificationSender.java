...
public class NotificationSender {
	...
	public void send() {
		...
		try {
			...
			queueConnection = queueConnectionFactory.createQueueConnection(JMSHelper.QUEUE_USERNAME,JMSHelper.QUEUE_PASSWORD);
//			queueConnection = queueConnectionFactory.createQueueConnection();
		...
		try {
            ...
            System.err.println("NotificationSender: Exception " +
                "occurred: " + jms_ex.toString());
